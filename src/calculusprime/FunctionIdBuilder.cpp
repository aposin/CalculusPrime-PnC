...
std::string FunctionIdBuilder::createId(const std::string& functionName_, std::size_t numberOfArgs_)
{
    return bal::to_lower_copy(functionName_) + std::to_string(numberOfArgs_);
}
