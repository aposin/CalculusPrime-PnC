...
CollectingErrorListener::~CollectingErrorListener()
{
}

void CollectingErrorListener::syntaxError(antlr4::Recognizer* recognizer, antlr4::Token* offendingSymbol, size_t line, size_t charPositionInLine,
                                          const std::string& msg, std::exception_ptr e)
{
    std::ostringstream err;
    err << "line:" << line << " position in line:" << charPositionInLine << " msg:" << msg;
